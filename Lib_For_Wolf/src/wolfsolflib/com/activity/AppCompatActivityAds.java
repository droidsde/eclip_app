...
import wolfsolflib.com.makemoney.Billing;
...
public abstract class  AppCompatActivityAds extends W7Common {
	...
	public void WloadAdsSmartBanner(int LayoutAdsId) {
		if(admob!=null)
		{
			Log.d(TAG, "PloadAdsBanner ");
			admob.displaySmartBanner(LayoutAdsId);
		}
	}
	...
	//Billing
	public void WsetupBilling(String base64EncodedPublicKey) {
		billing = new Billing(this, base64EncodedPublicKey);
	}
