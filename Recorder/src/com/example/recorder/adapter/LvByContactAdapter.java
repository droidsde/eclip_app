...
import com.example.recorder.GetContacts;
...
public class LvByContactAdapter  extends BaseAdapter{ 
    ...
    public LvByContactAdapter(Activity activity, ArrayList<String> prgmNameList, String packageFile) {
         ...
         rowView.setOnLongClickListener(new View.OnLongClickListener() {
 			...
 			public boolean onLongClick(View v) {
 	            ...
 	            if (context instanceof CallRecorder) {
 	                ...
 	                LvFileAdapter.linkFile = root + packageFile + result.get(position);
 	            }
 				return true;
 			}
 		});
