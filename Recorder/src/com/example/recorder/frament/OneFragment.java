...
//	String date, phone, time;
    ...
    public void ShowSavedFiles(){
    	...
    	ArrayList<String> filesinfolder = GetFiles(root +"/ss/");
    	Collections.reverse(filesinfolder);
    	   try {
    		   LvFileAdapter adapter
    		   = new LvFileAdapter(getActivity(), filesinfolder, "/ss/");
    ...
    public void showByContact()
    {
    	...
    	try {
 		   ...
 		   = new LvByContactAdapter(getActivity(), arrByContact, "/ss/");
