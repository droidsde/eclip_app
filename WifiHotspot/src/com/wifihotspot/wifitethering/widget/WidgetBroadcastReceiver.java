package com.wifihotspot.wifitethering.widget;
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (intent.getAction().equals(WidgetProvider.TURN_ON_AP)) {
            if (mWifiAPUtils.setAP(true)) {
                remoteViews.setImageViewResource(R.id.widget_img, R.drawable.icon_en);
            ...
            if (mWifiAPUtils.setAP(false)) {
                ...
                remoteViews.setImageViewResource(R.id.widget_img, R.drawable.dis);
