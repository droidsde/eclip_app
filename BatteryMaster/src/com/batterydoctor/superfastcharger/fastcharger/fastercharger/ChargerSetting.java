...
public class ChargerSetting extends WSettings {
	...
	public static String  CBOPEN="cbopen";
	public static String  TIMEOUT="Timeout";
	public static String  AUTOSCREEN="AutoScreen";
	public static String  SOUNDLOW = "soundlow";
	
	
	
	public static void saveLow(Context context, boolean check){
		save(context, SOUNDLOW, check);
	}
	public static boolean readLow(Context context){
		return read(context, SOUNDLOW, false);
	}
	...
	public static boolean readSttBL(Context context){
		return read(context, STTBT, false);
	}
	...
	public static boolean readSttWF(Context context){
		return read(context, STTWF, false);
	}
	...
	public static boolean readSttGPS(Context context){
		return read(context, STTGPS, false);
	}
	...
	public static void saveOpen(Context context, boolean check){
		save(context, CBOPEN, check);
	}
	public static boolean readOPEN(Context context){
		return read(context, CBOPEN, true);
	}
