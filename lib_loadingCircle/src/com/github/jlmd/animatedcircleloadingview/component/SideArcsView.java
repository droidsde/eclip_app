...
public class SideArcsView extends ComponentViewAnimation {
  ...
  public void startRotateAnimation() {
    ...
    valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
      ...
      public void onAnimationUpdate(ValueAnimator animation) {
        startLeftArcAngle = INITIAL_LEFT_ARC_START_ANGLE + (Integer) animation.getAnimatedValue();
        startRightArcAngle = INITIAL_RIGHT_ARC_START_ANGLE - ((Integer) animation.getAnimatedValue());
        invalidate();
      }
    });
    valueAnimator.start();
  ...
  public void startResizeDownAnimation() {
    ...
    valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
      @Override
      public void onAnimationUpdate(ValueAnimator animation) {
        arcAngle = (Integer) animation.getAnimatedValue();
        invalidate();
      }
    });
