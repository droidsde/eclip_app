...
import com.mbapp.lib_tool.Json.WJSONParser;
import com.mbapp.lib_tool.Json.WJsonReader;
import com.mbapp.lib_tool.adapter.WImageAdapterGird;
import com.mbapp.lib_tool.model.WTinyDB;
...
public class Wadsgridexit {
	...
	int mwidth; 
	int mheight;
	public Wadsgridexit(Context mContext,String Url){
	...
	public void intdialog(){
	    ...
	    View view = inflater.inflate(R.layout.wdialog_more_app_grid_exit,null);
	    AlertDialog.Builder builder = new AlertDialog.Builder(mContext);
	    grid = (GridView)view.findViewById(R.id.wgridads);
	...
	public void showads(){
	    ...
	    dialogAdsGrid.show();
		if(mwidth<mheight)
			dialogAdsGrid.getWindow().setLayout(mwidth,(int)(mheight/1.3));
		else 
...
public class GetAppFrist extends AsyncTask<Void, Void, Void>{
	...
	public void setListView() {
		...
		adapter = new WImageAdapterGird(mContext, ArrApp);
		((GridView) grid).setAdapter(adapter);
