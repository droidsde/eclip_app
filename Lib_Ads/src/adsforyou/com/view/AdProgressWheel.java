 ...
 */
public class AdProgressWheel extends View {
    private static final String TAG = AdProgressWheel.class.getSimpleName();
     ...
     * @param attrs
     */
    public AdProgressWheel(Context context, AttributeSet attrs) {
        super(context, attrs);

        parseAttributes(context.obtainStyledAttributes(attrs,
                R.styleable.AdProgressWheel));
    }
     ...
     * @param context
     */
    public AdProgressWheel(Context context) {
        super(context);
    }
    ...
    private void parseAttributes(TypedArray a) {
        ...
        circleRadius = (int) a.getDimension(R.styleable.AdProgressWheel_matProg_circleRadius, circleRadius);

        fillRadius = a.getBoolean(R.styleable.AdProgressWheel_matProg_fillRadius, false);

        barWidth = (int) a.getDimension(R.styleable.AdProgressWheel_matProg_barWidth, barWidth);

        rimWidth = (int) a.getDimension(R.styleable.AdProgressWheel_matProg_rimWidth, rimWidth);

        float baseSpinSpeed = a.getFloat(R.styleable.AdProgressWheel_matProg_spinSpeed, spinSpeed / 360.0f);
        spinSpeed = baseSpinSpeed * 360;

        barSpinCycleTime = a.getInt(R.styleable.AdProgressWheel_matProg_barSpinCycleTime, (int) barSpinCycleTime);

        barColor = a.getColor(R.styleable.AdProgressWheel_matProg_barColor, barColor);

        rimColor = a.getColor(R.styleable.AdProgressWheel_matProg_rimColor, rimColor);

        linearProgress = a.getBoolean(R.styleable.AdProgressWheel_matProg_linearProgress, false);

        if (a.getBoolean(R.styleable.AdProgressWheel_matProg_progressIndeterminate, false)) {
            spin();
        }
