...
public class AdRaterExit {
	...
	public AdRaterExit(Context mcContext, String nameapp){
		c = mcContext;
		appmain =nameapp ;
		utils = new AdUtils(c);
	...
	public void intdialog1(){
	   ...
	   final AdProgressWheel spinner = (AdProgressWheel) view.findViewById(R.id.wprogress_image);
		Picasso.with(c)
		   .load(appIcon)     
		   .resize(100, 100)
