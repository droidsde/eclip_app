package com.tethering.wifihotspot.common;
...
public class WifiAPUtils {
    ...
    public static final String DEFAULT_SSID = "WiFi Hotspot";
    public static final String SECURE_OPEN = "WPA2";
...
//        configuration.allowedKeyManagement.set(WifiConfiguration.KeyMgmt.WPA_EAP);
        configuration.allowedAuthAlgorithms.set(WifiConfiguration.KeyMgmt.WPA_EAP);
